...
const EvaluationForm = () => {
    ...
    const getCodeInput = () => <div className="w-[90%] lg:w-[60%] xl:w-[40%] flex flex-col gap-10 mx-auto">
        ...
        {<p className={`text-center ${bgColorStyles.inverse} rounded-full py-2 text-rose-500 ${formState.invalid_code ? "opacity-100" : "opacity-0"} ${transitioner.simple}`}>Invalid code entered</p>}
