...
const TermsOfService = () => {
    return <div className={`${pageLayoutStyles.scrollable}`}>
        <div className="w-[100%] md:w-[80%] lg:w-[70%] mx-auto">
            ...
            <p className={`text-justify my-2`}>Please read our <Link to="/privacy-policy" className={`${textColorStyles.clickable} ${transitioner.simple}`} target="_blank" rel="noreferrer">Privacy Policy</Link>.</p>
