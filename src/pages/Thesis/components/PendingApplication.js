          ...
          {pendingApplications.map((pendingApplication, index) => (
            <div className="flex flex-row items-center gap-4" key={index}>
              {pendingApplication.type === "thesis" && (
                <span
                  className={`material-icons-round text-black text-2xl bg-[#FCF3FD] px-2 py-1 rounded-full`}
                >
                  import_contacts
                </span>
              )}
              {pendingApplication.type === "internship" && (
                <span
                  className={`material-icons-round text-black text-2xl bg-[#F7FAE9] px-2 py-1 rounded-full`}
                >
                  group
                </span>
              )}
              {pendingApplication.type === "project" && (
                <span
                  className={`material-icons-round text-black text-2xl bg-[#FFEFE2] px-2 py-1 rounded-full`}
                >
                  computer
                </span>
              )}
