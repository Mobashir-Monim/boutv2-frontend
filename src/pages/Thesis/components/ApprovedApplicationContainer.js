          ...
          {approvedApplications.map((approvedApplication, index) => (
            ...
            >
              <SimpleCardCustomColor
                showTitle={false}
                customStyle={`max-w-[800px] border-none flex flex-row items-center justify-between ${
                  approvedApplication.type === "thesis"
                    ? "bg-[#fcf3fd] text-black"
                    : ""
                } ${
                  approvedApplication.type === "project"
                    ? "bg-[#ffefe2] text-black"
                    : ""
                } ${
                  approvedApplication.type === "internship"
                    ? "bg-[#F7FAE9] text-black"
                    : ""
                }`}
              >
                <div className="flex flex-col max-w-[70%]">
                  <h1 className="mb-2 font-bold text-lg break-normal">
                ...
                {approvedApplication.type === "thesis" && (
                  <span
                    className={`material-icons-round my-auto font-bold ${transitioner.simple} text-black bg-black bg-opacity-5 p-2 rounded-md`}
                  >
                    import_contacts
                  </span>
                )}
                {approvedApplication.type === "project" && (
                  <span
                    className={`material-icons-round my-auto font-bold ${transitioner.simple} text-black bg-black bg-opacity-10 p-2 rounded-md`}
                  >
                    computer
                  </span>
                )}
